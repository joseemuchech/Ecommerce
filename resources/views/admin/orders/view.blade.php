        ...
        <div class="card">
            ...
            <div class="card-body">
                 ...
                 <h4 class="text-primary">
                   ...
                   <a href="{{ url('admin/invoice/'.$order->id.'/generate') }}" target="_blank" class="btn btn-primary btn-sm float-end mx-1" >
                    Download Invoice
                   </a>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <form action="{{ url('admin/orders/'.$order->id) }}" method="POST">
                                    ...
                                    <label for="">Update You Order Status </label>
                            ...
                            <div class="col-md-7">
                                <br/>
                                <h4 class="mt-3">Current Order Status: <span class="text-uppercase text-warning">{{ $order->status_message }}</span></h4>
                            </div>
                        </div>
                    </div>
                </div>
