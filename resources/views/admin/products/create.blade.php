            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade border p-2" id="color-tab-pane" role="tabpanel" aria-labelledby="color-tab" tabindex="0">
                        <div class="mb-3">
                    ...
                    <div class="">
                      <button type="submit" class="btn text-white btn-primary float-end">Submit</button>
                    </div>
                </form>
            </div>
        </div>
