...
<div class="row">
    <div class="col-md-3">
        <div class="card card-body bg-primary text-white mb-3">
            ...
            <h1>{{ $totalOrder }}</h1>
            <a href="{{ url('admin/orders') }}" class="text-white">View Details</a>
        </div>
    </div>
    <div class="col-md-3">
...
<div class="row">
    <div class="col-md-3">
        <div class="card card-body bg-primary text-white mb-3">
            ...
            <h1>{{ $totalProducts }}</h1>
            <a href="{{ url('admin/products') }}" class="text-white">View Details</a>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card card-body bg-success text-white mb-3">
            ...
            <a href="{{ url('admin/category') }}" class="text-white">View Details</a>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card card-body bg-danger text-white mb-3">
            ...
            <h1>{{ $totalBrands }}</h1>
            <a href="{{ url('admin/brands') }}" class="text-white">View Details</a>
        </div>
    </div>
</div>
<hr/>
<div class="row">
    <div class="col-md-3">
        <div class="card card-body bg-primary text-white mb-3">
            ...
            <h1>{{ $totalAllUsers }}</h1>
            <a href="{{ url('admin/users') }}" class="text-white">View Details</a>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card card-body bg-success text-white mb-3">
