    ...
    <div>
        <div class="footer-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="footer-heading">{{ $appSetting->website_name ?? 'Jm-Shop'}}</h4>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2">
                            <p>
                                <i class="fa fa-map-marker"></i> {{ $appSetting->address ?? '56,Mombasa Kenya'}}
                            </p>
                        </div>
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-phone"></i> {{ $appSetting->phone1 ?? '+254 888-000-666'}}
                            </a>
                        </div>
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-envelope"></i> {{ $appSetting->email1 ?? 'jmit@gmail.com'}}
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class=""> &copy; 2022 - Jm - Ecommerce. All rights reserved.</p>
                    </div>
                    <div class="col-md-4">
