                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">Ksh {{ $this->totalProductAmount }}</span>
                        </h4>
                        <hr>
...
@push('scripts')
<script src="https://www.paypal.com/sdk/js?client-id=Ac74mUaN1m19u5NBC-exKGIyXKiSKlktSFYDNGyZz71axTiSJ4lMrhhule7PFnEyK3zEP11apnVsQcuD&currency=USD"></script>
